...
2. [Optimizing a neural network with backward propagation](#2-optimizing-a-neural-network-with-backward-propagation)
	- [Coding how weight changes affect accuracy](#coding-how-weight-changes-affect-accuracy)
	- [Scaling up to multiple data points](#scaling-up-to-multiple-data-points)
